...
2. Improved the Searching spec for the validations on the #``resource_name`` attribute, the #``platform_name`` attribute, & the #``platform_version`` attribute
...
2. Improved the Searching spec for the validations on the #resource_name attribute, & the #platform_name attribute
...
5. Improved the Acting spec, the Obsolescing spec, the Searching spec, & the State Transition spec for the As Caused concern
...
2. Improved the RSpec shared examples manifest to require the As Obsolescer Party shared examples

## v1.17.12
1. As Searcher Party shared examples
2. Improved the RSpec shared examples manifest to require the As Searcher Party shared examples

## v1.17.13
1. As State Subject shared examples
2. Improved the RSpec shared examples manifest to require the As State Subject shared examples
